...
module.exports = {
    ...
    head: [
        ...
        ['script', { async: true, src: 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3100848271969177', crossorigin: 'anonymous' }],
    ...
    theme: defaultTheme({
        ...
        locales: {
            ...
            '/de/': {
                ...
                editLinkText: 'Hilf mit, diesen Artikel zu verbessern',
                selectLanguageName: 'Deutsch',
                sidebar: genSidebar('de'),
            },
        },
